...
import com.nebulacompanies.nebula.fragments.Projects;
import com.nebulacompanies.nebula.fragments.Promoters;
...
public class CompanyProfile extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new EBrochures(), getResources().getString(R.string.about_us));
        adapter.addFragment(new Promoters(), getResources().getString(R.string.Promoters));
        adapter.addFragment(new Projects(), getResources().getString(R.string.projects_));
